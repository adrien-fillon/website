...
- icon: envelope
  icon_pack: fas
  link: 'mailto:adrienfillon@hotmail.fr'
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/adfillon
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.co.uk/citations?user=uHQ0z7cAAAAJ&hl
- icon: github
  icon_pack: fab
  link: https://github.com/adrien-fillon/
